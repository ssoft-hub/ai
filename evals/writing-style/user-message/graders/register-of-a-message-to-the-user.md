...
The response is a message to the user, which is a conversation. It passes when every sentence of it stands in the register the rule below fixes for that kind of text, and fails when any sentence stands in the other one.
