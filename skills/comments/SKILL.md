...
Deleting the comment is recommended wherever the reason for keeping it is one of these:
- "This might help the next reader" — not enough; the bar is they get it *wrong* without it.
- "This expression is non-obvious, I'll explain it" — naming it (extract a constant or function) is recommended instead of prose.
